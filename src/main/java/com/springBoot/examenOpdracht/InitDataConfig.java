...
public class InitDataConfig implements CommandLineRunner {
    ...
    public void run(String... args) {
    	...
    	Competition c1 = new Competition(LocalDate.of(2024, 5, 15), "14:00", s1, "13579", "14579", "Sprint & High Jump", null, 50, 25.0, 48);
    	Competition c6 = new Competition(LocalDate.of(2024, 5, 17), "15:30", s6, "24680", "25680", "Long Jump & Discus Throw", null, 40, 22.5, 1);
    	Competition c11 = new Competition(LocalDate.of(2024, 5, 16), "13:00", s11, "35791", "36791", "Marathon & Shot Put", null, 46, 20.0, 1);
    	Competition c16 = new Competition(LocalDate.of(2024, 5, 17), "11:30", s16, "46802", "47802", "Hurdles & Pole Vault", null, 37, 23.0, 15);
    	...
    	Competition c2 = new Competition(LocalDate.of(2024, 5, 18), "11:00", s2, "57913", "58913", "Floor Exercise & Rings", null, 30, 30.0, 16);
    	Competition c7 = new Competition(LocalDate.of(2024, 5, 19), "10:00", s7, "68024", "69024", "Vault & Parallel Bars", null, 25, 35.0, 23);
    	Competition c12 = new Competition(LocalDate.of(2024, 5, 18), "14:30", s12, "79135", "70135", "Balance Beam & Horizontal Bar", null, 35, 32.5, 20);
    	Competition c17 = new Competition(LocalDate.of(2024, 5, 19), "16:00", s17, "80246", "81246", "Trampoline & Uneven Bars", null, 30, 27.5, 10);
    	...
    	Competition c3 = new Competition(LocalDate.of(2024, 5, 20), "17:30", s3, "91357", "92357", "Indoor Volleyball", null, 28, 20.0, 8);
    	Competition c8 = new Competition(LocalDate.of(2024, 5, 21), "16:45", s8, "12468", "13468", "Beach Volleyball", null, 27, 18.0, 7);
    	Competition c13 = new Competition(LocalDate.of(2024, 5, 20), "19:15", s13, "23579", "14579","Beach Volleyball", "Mixed Volleyball", 19, 25.0, 9);
    	Competition c18 = new Competition(LocalDate.of(2024, 5, 21), "15:45", s18, "34680", "25680", "Sitting Volleyball", null, 13, 22.0, 3);
    	...
    	Competition c4 = new Competition(LocalDate.of(2024, 5, 22), "19:00", s4, "45791", "36791", "3x3 Basketball", null, 46, 35.0, 40);
    	Competition c9 = new Competition(LocalDate.of(2024, 5, 23), "18:30", s9, "56802", "47802", "Women's Basketball", "Men's Basketball", 45, 28.0, 30);
    	Competition c14 = new Competition(LocalDate.of(2024, 5, 22), "20:30", s14, "67913", "58913", "Slam Dunk Contest", null, 40, 30.0, 20);
    	Competition c19 = new Competition(LocalDate.of(2024, 5, 23), "17:45", s19, "78024", "69024", "Women's Basketball", "3x3 Basketball", 50, 32.0, 1);
