...
@Entity @NoArgsConstructor @EqualsAndHashCode(exclude = "id")
public class Competition implements Serializable {
	...
	@Column(unique = true)
    @NotNull @NotEmpty @NotBlank(message = "Olympic number 1 is required") @Getter @Setter
    private String olympicNumber1;
	
    @NotNull @NotEmpty @NotBlank(message = "Olympic number 2 is required") @Getter @Setter
    ...
    public Competition (LocalDate date, LocalTime time, String olympicNumber1, String olympicNumber2, 
    ...
    public Competition (LocalDate date, LocalTime time, String olympicNumber1, String olympicNumber2, 
    		String discipline1, String discipline2, int totalTickets, double price) {
    	setDate(date);
    	setDiscipline1(discipline1);
    	setDiscipline2(discipline2);
    	setOlympicNumber1(olympicNumber1);
