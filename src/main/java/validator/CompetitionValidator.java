...
public class CompetitionValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (competition.getOlympicNumber1().charAt(0) == competition.getOlympicNumber1().charAt(competition.getOlympicNumber1().length() - 1))
		...
		try {
	       ...
	       if (number2 < number1 - 1000 || number2 > number1 + 1000)
	    	   errors.rejectValue("olympicNumber2", "Olympic number2 is not within the valid range of Olympic number1 ± 1000");
